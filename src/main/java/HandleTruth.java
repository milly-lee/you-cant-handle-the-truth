...
public class HandleTruth {
    public static void wordCount() {
        ...
        HashMap<String, Integer> wordMap = countWords(msg);

        for (Map.Entry<String, Integer> entry : wordMap.entrySet()) {
            System.out.println(entry);
        }

        TreeMap<Integer,Set<String>> sortedMap =  orderWords(wordMap);
    ...
    public static  HashMap<String,Integer> countWords( String msg) {
    ...
    public static TreeMap<Integer, Set<String>> orderWords (HashMap<String, Integer> wordMap){
